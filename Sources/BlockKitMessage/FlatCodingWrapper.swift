...
*/
public protocol SingleCasedEnum: CaseIterable {
...
*/
public protocol ShadowEnum: Codable, RawRepresentable, CaseIterable, CaseNameReflectable {
	/**
...
extension ShadowEnum {
	...
	public init?(shadowing other: CaseNameReflectable) {
...
*/
public protocol FlatCodingWrapper: FlatCodable {
...
public extension FlatCodingWrapper where Self: CaseNameReflectable, CodingValue: ShadowEnum {
